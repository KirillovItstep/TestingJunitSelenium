...
public class UnimallChrome {
    ...
    public void openBrowser() {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\vadim\\IdeaProjects\\TestingJunitSelenium\\src\\main\\resources\\chromedriver.exe"); // указали путь к драйверу
    ...
    public void pressPassword(){
        ...
        System.out.println(baseUrl + "index.php?route=account/password");
        /*
